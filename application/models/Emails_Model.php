<?php
    ...
    class Emails_Model extends CI_Model {
        ...
        public function SendDesbursalMail($loanDetails) {
                ...
                <html xmlns="http://www.w3.org/1999/xhtml">
                   ...
                   <body>
                      <table width="778" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:10px; border:solid 1px #ccc; font-family:Arial, Helvetica, sans-serif;">
                         <tr>
                            <td width="381" align="left"><img src="' . EMAIL_BRAND_LOGO . '" class="img-responsive" alt="logo"/></td>
                         ...
                         <tr>
                            <td><strong>' . BRAND_NAME . ' app Lead partner of ' . BRAND_NAME . '.com</strong></td>
                            <td>&nbsp;</td>
                         ...
                         <tr>
                            <td colspan="3" style="font-size:17px;
                               line-height: 25px;
                               padding-bottom: 6px;"><strong>' . BRAND_NAME . '.com Powered by ' . COMPANY_NAME . '. (RBI approved NBFC) </strong></td>
                         </tr>
                         <tr>
                            <td colspan="3" style="font-size:17px;
                               line-height: 25px;
                               padding-bottom: 6px;"><strong>' . REGISTED_ADDRESS . ' </strong></td>
                         </tr>
                         <tr>
                            <td colspan="3" style="font-size:17px;
                               line-height: 25px;
            ...
            $this->email->bcc(CC_DISBURSAL_EMAIL);
            $this->email->subject('Loan Disbursal Letter - ' . BRAND_NAME . '');
