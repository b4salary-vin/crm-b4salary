...
<div class="login-box">
    <?= form_open('verifyUser', ['id' => 'formData', 'autocomplete' => 'off']); ?>
        <img src="<?= LOGO; ?>" alt="logo">
        <h3>FORGOT PASSWORD?</h3>
        <hr>
        <p>Kindly use your Email to Reset Password</p>
        <?php 
        ...
        <button class="btn btn-primary btn-block" id="userSignin" type="submit">GET OTP</button>
