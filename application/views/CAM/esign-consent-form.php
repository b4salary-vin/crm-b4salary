                            ...
                            <table class='table table-striped table-bordered'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>&#8377;&nbsp;
                                            <?php
                                            echo number_format(round($cam_data['loan_recommended'], 0), 2);
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>&#8377;&nbsp;
                                            <?php
                                            echo number_format(round((($cam_data['loan_recommended'] * $cam_data['roi'] * $cam_data['tenure']) / 100), 0), 2);
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>&#8377;&nbsp;
                                            <?php
//                                            echo number_format(round((($cam_data['loan_recommended'] * $cam_data['processing_fee_percent']) / 100), 0), 2);
                                            echo number_format($cam_data['admin_fee'], 2);
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>&#8377;&nbsp;
                                            <?php
                                            echo number_format(round($cam_data['net_disbursal_amount'], 0), 2);
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>&#8377;&nbsp;
                                            <?php
                                            echo number_format(round($cam_data['repayment_amount'], 0), 2);
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
