                ...
                <div class="col-md-12">
                    <div class="tab" role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <?php }
                            if (in_array(agent, ["AU", "CR1", "CR2", "CR3", "AC1", "AC2", "CA", "SA", "DS1", "DS2", "CO1", "CO2", "CO3", "CO4", "CC"]) || $url == "search") { ?>
                            ...
                            <?php }
                            if (in_array(agent, ["AU", "CR2", "CR3", "AC1", "AC2", "CA", "SA", "DS1", "DS2", "CO1", "CO2", "CO3", "CO4", "CFE1"]) || $url == "search") { ?>
                            ...
                            if (in_array(agent, ["AU", "DS1", "DS2", "CR3", "AC1", "AC2", "CO1", "CO2", "CO3", "CO4", "CA", "SA", "CC"]) || $url == "search") {
                            ?>
                            ...
                            <?php }
                            if ((in_array($leadDetails->stage, array("S14", "S16")) && agent == 'CR2' && $leadDetails->lead_credit_assign_user_id == user_id) || in_array(agent, ["AU", "AC1", "AC1", "AC2", "CO1", "CO2", "CO3", "CO4", "CFE1", "CA", "SA", "CO4", "CC"]) || $url == "search") { ?>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="DocumentSaction">
                                ...
                                <div id="documents" class="show">
                                    <div id="btndivUploadDocs">
                                        <?php if (agent == 'CA' || (in_array(agent, ["CR1", "CR2"]) && in_array($leadDetails->stage, ["S2", "S3", "S5", "S6", "S11"]) && $leadDetails->customer_bre_run_flag == 0)  || $leadDetails->lead_status_id < 14) { ?>
                                ...
                                <div id="btndivReject1">
                                    <div calss="row" style="border-top: solid 1px #ddd;text-align: center; padding-top : 20px; padding-bottom: 20px; background: #f3f3f3; overflow: auto;">
                                        ...
                                        <?php } */ ?>
                                            ...
                                            <?php }
                                            if (agent == 'CR1' && !empty($leadDetails->lead_screener_assign_user_id) && $leadDetails->lead_screener_assign_user_id == user_id && in_array($leadDetails->lead_status_id, array(2, 3)) && ($leadDetails->user_is_loanwalle != 2)) { ?>
                                                <button class="btn btn-success reject-button" onclick="RejectedLoan()">Reject</button>
                                            <?php } else if ((agent == 'CR1' || agent == 'CA') && !empty($leadDetails->lead_rejected_assign_user_id) && $leadDetails->lead_rejected_assign_user_id == user_id && in_array($leadDetails->lead_status_id, array(9)) && in_array($leadDetails->lead_rejected_reason_id, array(7, 31)) && $leadDetails->lead_rejected_assign_counter <= NON_CONTACTABLE_ROTATE_COUNTER) { ?>
                                                <button class="btn btn-success reject-button" onclick="RejectedLoan()">Reject</button>
                                            <?php } else if (agent == 'CR2' && !empty($leadDetails->lead_credit_assign_user_id) && $leadDetails->lead_credit_assign_user_id == user_id && in_array($leadDetails->lead_status_id, array(5, 6, 11)) && ($_SESSION['isUserSession']['user_is_loanwalle'] != 2)) { ?>
                                                <button class="btn btn-success reject-button" onclick="RejectedLoan()">Reject</button>
                                            <?php } else if (agent == 'CR3' && in_array($leadDetails->lead_status_id, array(10))) { ?>
                                                <button class="btn btn-success reject-button" onclick="RejectedLoan()">Reject</button>
                                            <?php } else if (agent == 'DS1' || agent == 'DS2' && !empty($leadDetails->lead_disbursal_assign_user_id) && $leadDetails->lead_disbursal_assign_user_id == user_id && in_array($leadDetails->lead_status_id, array(30, 35, 37))) { ?>
                                                <button class="btn btn-success reject-button" onclick="RejectedLoan()">Reject</button>
                                            ...
                                            <?php } else if (agent == 'CR2' && !empty($leadDetails->lead_credit_assign_user_id) && $leadDetails->lead_credit_assign_user_id == user_id && in_array($leadDetails->lead_status_id, array(5))) { ?>
                                                <button class="btn btn-success lead-hold-button" onclick="holdLeadsRemark()">Hold</button>
                                            <?php } else if (agent == 'DS1' || agent == 'DS2' && !empty($leadDetails->lead_disbursal_assign_user_id) && $leadDetails->lead_disbursal_assign_user_id == user_id && in_array($leadDetails->lead_status_id, array(30, 35))) { ?>
                                                <button class="btn btn-success lead-hold-button" onclick="holdLeadsRemark()">Hold</button>
                                            <?php } ?>
                                            ...
                                            <?php }
                                            if ((agent == 'CR2' && $leadDetails->user_type == 'REPEAT' && !empty($leadDetails->lead_credit_assign_user_id) && $leadDetails->lead_credit_assign_user_id == user_id) && in_array($leadDetails->lead_status_id, array(5, 65)) && ($camDetails->cam_status == 1 && $leadDetails->lead_fi_residence_status_id != 1 && $leadDetails->lead_fi_office_status_id != 1)) { ?>
                                            ...
                                            <?php } else if ((agent == 'CR3') && in_array($leadDetails->lead_status_id, array(10, 65)) && ($camDetails->cam_status == 1 && $leadDetails->lead_fi_residence_status_id != 1 && $leadDetails->lead_fi_office_status_id != 1)) { ?>
                                                <button class="btn btn-primary" style="background : #0a5e90 !important;" onclick="sanctionFeedback('<?= $this->encrypt->encode($leadDetails->lead_id) ?>')">Sanction</button>
                                            <?php } ?>
