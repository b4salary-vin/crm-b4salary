                                ...
                                <div class="row">
                                    <form id="search" enctype="multipart/form-data" class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <label class="labelField">LEAD ID&nbsp;</label>
                                                <input type="text" class="form-control inputFieldsearch" name="lead_id" id="lead_id" title="Lead ID" autocomplete="off">     
                                            </div>
                                            <div class="col-md-6">
                                                <label class="labelField">LEAD REFERENCE No.&nbsp;</label>
                                                <input type="text" class="form-control inputFieldsearch" name="lead_reference_no" id="lead_reference_no" title="LEAD REFERENCE No" autocomplete="off">     
                                            </div>  
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <label class="labelField">AADHAAR&nbsp;</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control inputFieldsearch" name="email" id="email" title="Email" autocomplete="off">     
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script>
    ...
    $('#lead_id, #lead_reference_no, #application_no, #loan_no, #pancard, #name, #mobile, #aadhar, #cif').keypress(function (e) {
        if (e.which == 13) {
            searchLeads(e);
        }
    });
    ...
    function searchLeads(e)
    {
        ...
        var lead_reference_no = $("#lead_reference_no").val();
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: "json",
            data: {lead_id: lead_id, lead_reference_no: lead_reference_no, application_no: application_no, loan_no: loan_no, name: name, mobile: mobile, pancard: pancard, aadhar: aadhar, cif: cif, email: email, csrf_token},
            beforeSend: function () {
